...
@implementation MIdentifierValidator
...
+ (BOOL) isValidPhone:(NSString*)value {
    ...
    if (![MIdentifierValidator isValidNumber:value])
    {
        return FALSE;
    }
...
+ (BOOL) isValidCreditNumber:(NSString*)value
{
    ...
    if (length >= 13)
    {
        result = [MIdentifierValidator isValidNumber:value];
        if (result)
        {
...
+ (BOOL) isValid:(IdentifierType) type value:(NSString*) value
{
    ...
    switch (type)
    {
        case IdentifierTypeZipCode:
            result = [MIdentifierValidator isValidZipcode:value];
            break;
        case IdentifierTypeEmail:
            //            result = [IdentifierValidator isValidEmail:value];
            result = [MIdentifierValidator validateEmail:value];
            break;
        case IdentifierTypePhone:
            result = [MIdentifierValidator isValidPhone:value];
            break;
        case IdentifierTypeUnicomPhone:
            result = [MIdentifierValidator isChinaUnicomPhoneNumber:value];
            break;
        ...
        case IdentifierTypeString:
            result = [MIdentifierValidator isValidString:value];
            break;
        case IdentifierTypeIdentifier:
            result = [MIdentifierValidator isValidIdentifier:value];
            break;
        case IdentifierTypePassort:
            result = [MIdentifierValidator isValidPassport:value];
            break;
        case IdentifierTypeCreditNumber:
            result = [MIdentifierValidator isValidCreditNumber:value];
            break;
        case IdentifierTypeBirthday:
            result = [MIdentifierValidator isValidBirthday:value];
            break;
        default:
            break;
    }
