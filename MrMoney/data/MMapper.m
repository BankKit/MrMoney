...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict exclude:(NSArray *)excludeArray {
    ...
    if ([obj respondsToSelector:@selector(rm_dataKeysForClassProperties)]) {
        dataKeysForProperties = [((id<MMapperDelegate>)obj) rm_dataKeysForClassProperties];
    }
    
    NSDictionary* properties = [MMapper propertiesForClass:cls];
...
//            MMapperLog(@"MMapper: key %@ is not existed in class or class mapping %@", property, NSStringFromClass(cls));
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if (![MMapper hasBasicPrefix:propertyType] &&
                ...
                [MMapper populateObject:childObj fromDictionary:value exclude:nil];
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict {
    obj = [MMapper populateObject:obj fromDictionary:dict exclude:nil];
...
+ (id)objectWithClass:(Class)cls fromDictionary:(NSDictionary *)dict {
    ...
    [MMapper populateObject:obj fromDictionary:dict];
...
+(NSArray *)arrayOfClass:(Class)cls fromArrayOfDictionary:(NSArray *)array {
    NSMutableArray *mutableArray = [MMapper mutableArrayOfClass:cls fromArrayOfDictionary:array];
...
+(NSMutableArray *)mutableArrayOfClass:(Class)cls fromArrayOfDictionary:(NSArray *)array {
    ...
    for (id item in array) {
        ...
        id obj = [MMapper objectWithClass:cls fromDictionary:item];
...
+ (NSDictionary*) mutableDictionaryForObject:(id)obj include:(NSArray*)includeArray {
    NSDictionary* properties = [MMapper propertiesForClass:[obj class]];
    ...
    for (NSString* property in properties) {
        ...
        if (![MMapper hasBasicPrefix:propertyType]) {
            val = [MMapper mutableDictionaryForObject:val include:nil];
        }
...
+ (NSMutableDictionary *)mutableDictionaryForObject:(id)obj {
    return [MMapper mutableDictionaryForObject:obj include:nil];
}

+(NSDictionary *)dictionaryForObject:(id)obj include:(NSArray *)includeArray {
    NSMutableDictionary* dict = [MMapper mutableDictionaryForObject:obj include:includeArray];
    return [NSDictionary dictionaryWithDictionary:dict];
}

+(NSDictionary*)dictionaryForObject:(id)obj {
    NSMutableDictionary *mutableDict = [MMapper mutableDictionaryForObject:obj];
