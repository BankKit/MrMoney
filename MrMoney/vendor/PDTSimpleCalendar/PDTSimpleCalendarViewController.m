...
//    
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(notification:) name:@"calendar" object:nil];
}
...
- (void)viewDidLoad
{
    ...
    if (IsIOS7) {
        self.collectionView.frameHeight =  self.view.bounds.size.height - 20;
        self.collectionView.frameY = 20;
    }
    ...
    [self.overlayView setTranslatesAutoresizingMaskIntoConstraints:YES];
