...
@property (nonatomic, assign) float animationHeight;
// 点击背景取消
...
- (CAAnimation *)showMenuAnimation
{
    if (_showMenuAnimation == nil) {
        ...
        self.animationHeight = topMenu.frame.size.height;
        
        CABasicAnimation *positionAnimation = [CABasicAnimation animationWithKeyPath:@"transform.translation.y"];
        [positionAnimation setFromValue:[NSNumber numberWithFloat:self.animationHeight ]];
...
- (CAAnimation *)dismissMenuAnimation
{
    if (_dismissMenuAnimation == nil) {
        ...
        [positionAnimation setToValue:[NSNumber numberWithFloat:self.animationHeight ]];
        //
        //        CABasicAnimation *opacityAnimation = [CABasicAnimation animationWithKeyPath:@"opacity"];
