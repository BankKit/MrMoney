...
@protocol MSendEmailActionDelegate
...
@end
@interface MSendEmailAction : MBaseAction
{
    
    ASIHTTPRequest *m_request;
    
    __weak id<MSendEmailActionDelegate> m_delegate;
}
@property(nonatomic,weak)id<MSendEmailActionDelegate> m_delegate;
