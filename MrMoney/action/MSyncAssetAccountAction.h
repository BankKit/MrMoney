...
@interface MSyncAssetAccountAction : MBaseAction
{
    
    ASIHTTPRequest *m_request;
    
    __weak id<MSyncAssetAccountActionDelegate> m_delegate;
}
@property(nonatomic,weak)id<MSyncAssetAccountActionDelegate> m_delegate;
