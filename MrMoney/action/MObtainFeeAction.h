...
@protocol MObtainActionDelegate
...
@end
@interface MObtainFeeAction : MBaseAction
{
    
    ASIHTTPRequest *m_request;
    
    __weak id<MObtainActionDelegate> m_delegate;
    
}
@property(nonatomic,weak)id<MObtainActionDelegate> m_delegate;
