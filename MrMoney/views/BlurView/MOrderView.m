...
-(void)setData:(MFinanceProductData *)data{
    ...
    _data = data;
        ...
        CGFloat height = [MStringUtility getStringHight:_data.mproduct_name font:SYSTEMFONT(16) width:190.];
        
        self.product_nameLabel.frameHeight = height + 5.;
        
        _topView.frameY                 = self.product_nameLabel.frameY + self.product_nameLabel.frameHeight - 5.;
